...
app = FastAPI(title='Backstract Generated APIs - coll-f0d1ce49f0274779832587d5e3525f6f', debug=False,
              docs_url='/thirsty-aryabhata-19bf1f08150811f0a0f60242ac12000498/docs',
              openapi_url='/thirsty-aryabhata-19bf1f08150811f0a0f60242ac12000498/openapi.json')
...
app.include_router(
    router,
    prefix='/thirsty-aryabhata-19bf1f08150811f0a0f60242ac12000498/api',
    tags=['APIs v1']
)
